...
Cada Carro pertence a uma Marca (ManyToOne). Uma Marca pode ter vários carros. Carro e Acessorio têm ManyToMany, pois o mesmo acessório pode equipar carros diferentes. A tabela carro_acessorio guarda a associação. Não há motivo para limitar uma marca a um único carro com OneToOne.
