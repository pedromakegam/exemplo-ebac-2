...
Serviço separado a partir do monólito oficial. Cadastro e consulta em /memelandia/usuarios.

JDK 17 e Maven. Na raiz do repositório:

```sh
mvn -pl java-pro/mod17/usuarios-service -am verify
mvn -pl java-pro/mod17/usuarios-service spring-boot:run
```
