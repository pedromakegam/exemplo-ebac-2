# Memelândia - categorias

Serviço separado a partir do monólito oficial. Cadastro e consulta em /memelandia/categorias.

JDK 17 e Maven. Na raiz do repositório:

```sh
mvn -pl java-pro/mod17/categorias-service -am verify
mvn -pl java-pro/mod17/categorias-service spring-boot:run
```
