...
CRUD independente em /clientes. POST retorna 201; GET lista ou consulta pelo id; PUT altera; DELETE remove. Ausência retorna 404 e duplicidade retorna 409.

JDK 17 e Maven. Na raiz do repositório:

```sh
mvn -pl mod42/cliente-service -am verify
mvn -pl mod42/cliente-service spring-boot:run
```
